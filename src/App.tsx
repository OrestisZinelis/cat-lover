          ...
          <div>
            <Routes>
              ...
              <Route path="/cats" element={<Cats />}>
                <Route path=":catId" element={<CatModal showAlert={showAlert} />} />
              </Route>
              <Route path="/breeds" element={<Breeds />}>
                <Route path=":breedId" element={<BreedModal showAlert={showAlert} />}>
                  <Route path="cats/:catId" element={<CatModal showAlert={showAlert} />} />
                </Route>
              </Route>
